/**
 * Express Server for User CRUD Operations
 * This version is fully compliant with all activity rubrics, 
 * using correct status codes, specific error messages, and proper error logging.
 */
